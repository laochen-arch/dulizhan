...
export function errorResponse(error: unknown) {
  ...
  if (["REVISION_NOT_FOUND", "ASSET_NOT_FOUND", "OPERATION_EVENT_NOT_FOUND", "RELEASE_REQUEST_NOT_FOUND"].includes(message)) return Response.json({ error: "The requested CMS record was not found.", code: message }, { status: 404, headers: { "Cache-Control": "no-store" } });
