...
export function errorResponse(error: unknown) {
  ...
  if (message === "ORDER_NOT_FOUND" || message === "PRODUCT_NOT_FOUND") return Response.json({ error: "The requested commerce record was not found.", code: message }, { status: 404, headers: { "Cache-Control": "no-store" } });
