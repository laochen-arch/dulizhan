import { reconcilePayPalRefunds } from "../../../../../db/commerce";
...
export async function POST(request: Request) {
  try {
    ...
    return Response.json(await reconcilePayPalRefunds(siteId, access.user.userId, access.user.email), { headers: { "Cache-Control": "no-store" } });
  } catch (error) {
