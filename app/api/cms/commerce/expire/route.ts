import { releaseExpiredOrderReservations } from "../../../../../db/commerce";
...
export async function POST(request: Request) {
  try {
    ...
    return Response.json(await releaseExpiredOrderReservations(siteId, access.user.userId, access.user.email), { headers: { "Cache-Control": "no-store" } });
  } catch (error) {
