...
export default function ShopPage() {
  ...
  function choosePrice(next: string) { setPriceFilter(next); setVisibleCount(12); syncUrl({ category, search: query, sort, price: next, availability }); }
  function chooseAvailability(next: string) { setAvailability(next); setVisibleCount(12); syncUrl({ category, search: query, sort, price: priceFilter, availability: next }); }
