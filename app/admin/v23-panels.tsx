...
export function V23ConfigurationPanel({ activeSiteId, cmsRole, onNotice }: { activeSiteId: string; cmsRole: CmsRole; onNotice: (notice: Notice) => void }) {
  ...
  return <section className="v23-config-shell">
