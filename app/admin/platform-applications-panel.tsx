...
const statusLabels: Record<string, string> = { submitted: "Submitted", reviewing: "Reviewing", needs_info: "Needs information", approved: "Approved", rejected: "Rejected", site_created: "Store created" };
