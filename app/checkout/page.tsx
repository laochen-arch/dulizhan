...
export default function CheckoutPage() {
  ...
  if (submitted) return <div className="empty-state container section-pad"><span className="empty-mark">OK</span><p className="eyebrow">Order received</p><h1>See you out there.</h1><p>Your demo order is in. We&apos;ll use this space for confirmation details when payments are connected.</p><Link href="/shop" className="button button-dark">Continue shopping -&gt;</Link></div>;
